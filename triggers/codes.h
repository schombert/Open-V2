...
namespace triggers {
	namespace effect_codes {
		...
		constexpr uint16_t country_event = 0x00ED;
		constexpr uint16_t country_event_immediate = 0x00EE;
		constexpr uint16_t province_event = 0x00EF;
		constexpr uint16_t province_event_immediate = 0x00F0;
	...
	inline const int32_t code_data_sizes[] = {
		...
		2, //constexpr uint16_t military_score_value = 0x013F;
		...
		2, //constexpr uint16_t rich_tax = 0x014B;
		2, //constexpr uint16_t middle_tax = 0x014C;
		2, //constexpr uint16_t poor_tax = 0x014D;
		2, //constexpr uint16_t social_spending_nation = 0x014E;
		2, //constexpr uint16_t social_spending_pop = 0x014F;
		2, //constexpr uint16_t social_spending_province = 0x0150;
		...
		2, //constexpr uint16_t military_spending_pop = 0x01D3;
		2, //constexpr uint16_t military_spending_province = 0x01D4;
		2, //constexpr uint16_t military_spending_state = 0x01D5;
		2, //constexpr uint16_t military_spending_nation = 0x01D6;
		2, //constexpr uint16_t administration_spending_pop = 0x01D7;
		2, //constexpr uint16_t administration_spending_province = 0x01D8;
		2, //constexpr uint16_t administration_spending_state = 0x01D9;
		2, //constexpr uint16_t administration_spending_nation = 0x01DA;
		2, //constexpr uint16_t education_spending_pop = 0x01DB;
		2, //constexpr uint16_t education_spending_province = 0x01DC;
		2, //constexpr uint16_t education_spending_state = 0x01DD;
		2, //constexpr uint16_t education_spending_nation = 0x01DE;
