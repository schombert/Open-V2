...
namespace triggers {
	...
	inline const int32_t effect_code_data_sizes[] = {
		...
		1, //constexpr uint16_t change_controller = 0x0031;
		0, //constexpr uint16_t change_controller_this_nation = 0x0032;
		0, //constexpr uint16_t change_controller_this_province = 0x0033;
		0, //constexpr uint16_t change_controller_from_nation = 0x0034;
		0, //constexpr uint16_t change_controller_from_province = 0x0035;
		1, //constexpr uint16_t infrastructure = 0x0036;
		2, //constexpr uint16_t money = 0x0037;
		2, //constexpr uint16_t leadership = 0x0038;
		1, //constexpr uint16_t create_vassal = 0x0039;
		0, //constexpr uint16_t create_vassal_this_nation = 0x003A;
		0, //constexpr uint16_t create_vassal_this_province = 0x003B;
		0, //constexpr uint16_t create_vassal_from_nation = 0x003C;
		0, //constexpr uint16_t create_vassal_from_province = 0x003D;
		1, //constexpr uint16_t end_military_access = 0x003E;
