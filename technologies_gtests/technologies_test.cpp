...
TEST(technologies_tests, read_technologies_test) {
	...
	EXPECT_EQ(3.0f, s.modifiers_m.national_modifier_definitions.get(s.technology_m.technologies_container[tech_tag(1)].modifier, modifiers::national_offsets::tax_efficiency));
